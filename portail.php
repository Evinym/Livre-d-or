...
<body>
	...
	<div>
		<h1>Connexion</h1>
		<br/><br/>
		<form method="post" action="account/login.inc.php">
			<label for="mail">name</label>
			<input type="text" id="name" name="mail" value="" placeholder="Username/E-mail"><br/>
			
			<label for="pwd">password</label>
			<input type="password" id="passwordd" name="pwd" placeholder="....."><br/>
