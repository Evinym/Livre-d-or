...
<form method="post" action="event.php">
	...
	<input type="text" name="name" id="name" value="" require/>

	<label for="surname">surname</label>
	<input type="text" name="surname" id="surname" value="" require/>

	<label for="passwordd">choose your password</label>
	<input type="password" name="passwordd" id="passwordd" value="" require/>
